...
import com.borymskyi.patterns.creational.builder2.building.CityHouse;
 ...
 * @version 1.0
 */
public class CityHouseBuilder implements BuildingBuilder {
    ...
    public CityHouse getResult() {
        return new CityHouse(typeBuilding, square, wall, floor, roof, entrance, window, swimmingPool, garage, moat,
