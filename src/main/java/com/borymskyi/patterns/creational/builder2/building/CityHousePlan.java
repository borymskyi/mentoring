...
public class CityHousePlan {
    ...
    public CityHousePlan(Type typeBuilding, int square, Wall wall, Floor floor, Roof roof, Entrance entrance,
    ...
    public String showPlan() {
        return "CityHousePlan{ " + "TypeBuilding=" + typeBuilding +
                ", square=" + square +
                ", wall=" + wall +
                ", floor=" + floor +
                ", roof=" + roof +
